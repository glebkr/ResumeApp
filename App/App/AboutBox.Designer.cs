namespace App
{
    partial class AboutBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "Название продукта: App";
            ...
            this.textBoxDescription.Text = "Данное ПО создано для успрощения работы  с информацией о кандидатах на вакантную " +
    "должность.\r\nПоддерживает функции записи, сохранения в файл, считывания из файла," +
